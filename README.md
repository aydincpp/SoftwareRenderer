# Software Graphics API

This project is a graphics API written from scratch in C99 for Linux (not finished). It has no dependencies and only works with the CPU.
